...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-group">
		...
		<ul class="wp-block-social-links has-small-icon-size has-icon-color is-style-logos-only">
			<!-- wp:social-link {"url":"https://instagram.com/fw.yuuta","service":"instagram"} /-->
		...
		<p class="has-small-font-size">
			<?php
			$wordpress_link = '<a href="' . esc_url( __( 'https://profile.intra.42.fr/users/yoayedde', 'lowfi' ) ) . '" rel="nofollow">yuuta</a>';
			echo sprintf(
			/* Translators: WordPress link. */
				esc_html__( 'Made by  %1$s', 'lowfi' ),
				$wordpress_link
			);?>
		</p>
		<!-- /wp:paragraph -->
